...
const ProductCard = ({product, onDelete} : ProductCardProps) => {
  ...
  <div>
    <h3 className="text-xl font-extrabold leading-snug text-black">{product.name}</h3>
    <p className="mt-3 line-clamp-3 text-sm leading-6 text-slate-700">{product.description}</p>
  </div>
